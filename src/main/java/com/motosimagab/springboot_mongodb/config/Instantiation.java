package com.motosimagab.springboot_mongodb.config;
...
import com.motosimagab.springboot_mongodb.dto.AuthorDTO;
import com.motosimagab.springboot_mongodb.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, LocalDate.parse("21/03/2018", fmt1), "Partiu viagem", "Vou viajar para São Paulo", new AuthorDTO(maria));
		...
		CommentDTO c3 = new CommentDTO("Tenha um ótimo dia", LocalDate.parse("23/03/2018", fmt1), new AuthorDTO(alex));
